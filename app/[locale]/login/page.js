...
// ✅ OPTIMIZED: Extract FormInput component
...
// ✅ OPTIMIZED: Extract RememberAndForgot component
const RememberAndForgot = memo(({ locale }) => (
...
RememberAndForgot.displayName = 'RememberAndForgot';

// ✅ OPTIMIZED: Extract SocialButton component
const SocialButton = memo(({ icon, label }) => (
  <button
    type="button"
...
// ✅ OPTIMIZED: Extract SocialLogins component
const SocialLogins = memo(() => (
  <div className="mt-6">
    ...
    <div className="mt-6 grid grid-cols-2 gap-3">
      <SocialButton icon={GOOGLE_SVG} label="Google" />
      <SocialButton icon={GITHUB_SVG} label="GitHub" />
    </div>
  </div>
));

SocialLogins.displayName = 'SocialLogins';

// ✅ OPTIMIZED: Extract FormHeader component
const FormHeader = memo(() => (
  <div className="text-center mb-8">
    <h1 className="text-3xl font-bold text-gray-900 mb-2">
      Welcome Back
    </h1>
    <p className="text-gray-600">Sign in to your Tijarah.pk account</p>
  </div>
));

FormHeader.displayName = 'FormHeader';

// ✅ OPTIMIZED: Extract FormFooter component
const FormFooter = memo(({ locale }) => (
...
const SubmitButton = memo(({ isLoading }) => (
  <button
    type="submit"
    disabled={isLoading}
...
export default function LoginPage() {
  ...
  // ✅ OPTIMIZED: Memoized input handlers
  ...
  // ✅ OPTIMIZED: Memoized form submission
      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-lg shadow-xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <RememberAndForgot locale={locale} />
